<?php
//USER REGISTRATION (from here: https://codeshack.io/secure-login-csystem-php-mysql/#creatingthehomepage )
...
if (!isset($_POST['username'], $_POST['password'], $_POST['confirmPass'])) {
